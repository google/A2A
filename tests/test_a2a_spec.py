...
def validate_instance(instance_data, definition_name, schema, resolver):
    ...
    try:
        ...
        pytest.fail(
            f'Unexpected error during validation for {definition_name}:\n{json.dumps(instance_data, indent=2)}\nError: {e}'
        )
...
def test_text_part(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'TextPart', schema, resolver
    )
    instance_minimal = TextPart(text='Minimal')
    validate_instance(
        instance_minimal.model_dump(mode='json'), 'TextPart', schema, resolver
    )
...
def test_file_content(schema, resolver):
    ...
    validate_instance(
        instance_bytes.model_dump(mode='json'), 'FileContent', schema, resolver
    )
    instance_uri = FileContent(name='test.txt', uri='file:///tmp/test.txt')
    validate_instance(
        instance_uri.model_dump(mode='json'), 'FileContent', schema, resolver
    )
...
def test_file_part(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'FilePart', schema, resolver
    )
...
def test_data_part(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'DataPart', schema, resolver
    )
...
def test_message(schema, resolver):
    ...
    validate_instance(
        instance_user.model_dump(mode='json'), 'Message', schema, resolver
    )
...
def test_artifact(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'Artifact', schema, resolver
    )
    instance_minimal = Artifact(parts=[DataPart(data={'status': 'ok'})])
    validate_instance(
        instance_minimal.model_dump(mode='json'), 'Artifact', schema, resolver
    )
    instance_chunk = Artifact(
        parts=[DataPart(data={'status': 'ok'})],
        index=1,
        lastChunk=False,
        append=True,
    )
    validate_instance(
        instance_chunk.model_dump(mode='json'), 'Artifact', schema, resolver
    )
...
def test_task(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'Task', schema, resolver
    )
    instance_minimal = Task(
        id=uuid4().hex, status=TaskStatus(state=TaskState.SUBMITTED)
    )
    validate_instance(
        instance_minimal.model_dump(mode='json'), 'Task', schema, resolver
    )
...
def test_task_status_update_event(schema, resolver):
    ...
    validate_instance(
        instance_final.model_dump(mode='json'),
        'TaskStatusUpdateEvent',
        schema,
        resolver,
    )
...
def test_authentication_info(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'AuthenticationInfo', schema, resolver
    )
    ...
    validate_instance(
        instance_extra.model_dump(mode='json'),
        'AuthenticationInfo',
        schema,
        resolver,
    )
...
def test_push_notification_config(schema, resolver):
    ...
    validate_instance(
        instance_no_auth.model_dump(mode='json'),
        'PushNotificationConfig',
        schema,
        resolver,
    )
...
def test_task_query_params(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'TaskQueryParams', schema, resolver
    )
    ...
    validate_instance(
        instance_minimal.model_dump(mode='json'),
        'TaskQueryParams',
        schema,
        resolver,
    )
...
def test_task_id_params(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'TaskIdParams', schema, resolver
    )
...
def test_task_send_params(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'TaskSendParams', schema, resolver
    )
...
def test_jsonrpc_error(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'JSONRPCError', schema, resolver
    )
...
def test_specific_errors(error_cls, schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), error_cls.__name__, schema, resolver
    )
    ...
    if 'data' in error_cls.model_fields and error_cls.model_fields[
        ...
        validate_instance(
            instance_with_data.model_dump(mode='json'),
            error_cls.__name__,
            schema,
            resolver,
        )
...
def test_send_task_response(schema, resolver):
    ...
    validate_instance(
        instance_task.model_dump(mode='json'),
        'SendTaskResponse',
        schema,
        resolver,
    )
    ...
    validate_instance(
        instance_update.model_dump(mode='json'),
        'SendTaskStreamingResponse',
        schema,
        resolver,
    )
    ...
    validate_instance(
        instance_error.model_dump(mode='json'),
        'SendTaskStreamingResponse',
        schema,
        resolver,
    )
...
def test_get_task_response(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'GetTaskResponse', schema, resolver
    )
...
def test_cancel_task_response(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'CancelTaskResponse', schema, resolver
    )
...
def test_get_task_push_notification_response(schema, resolver):
    ...
    validate_instance(
        instance_null.model_dump(mode='json'),
        'GetTaskPushNotificationResponse',
        schema,
        resolver,
    )
...
def test_a2a_request_union(request_instance, schema, resolver):
    ...
    try:
        ...
        pytest.fail(
            f'Unexpected error during A2ARequest validation ({request_instance.method}):\n{json.dumps(instance_data, indent=2)}\nError: {e}'
        )
...
def test_agent_provider(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'AgentProvider', schema, resolver
    )
    instance_min = AgentProvider(organization='MinOrg')
    validate_instance(
        instance_min.model_dump(mode='json'), 'AgentProvider', schema, resolver
    )
...
def test_agent_capabilities(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'AgentCapabilities', schema, resolver
    )
    instance_default = AgentCapabilities()
    validate_instance(
        instance_default.model_dump(mode='json'),
        'AgentCapabilities',
        schema,
        resolver,
    )
...
def test_agent_skill(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'AgentSkill', schema, resolver
    )
    instance_minimal = AgentSkill(id='echo', name='Echo Skill')
    validate_instance(
        instance_minimal.model_dump(mode='json'), 'AgentSkill', schema, resolver
    )
...
def test_agent_card(schema, resolver):
    ...
    validate_instance(
        instance.model_dump(mode='json'), 'AgentCard', schema, resolver
    )
    ...
    validate_instance(
        instance_minimal.model_dump(mode='json'), 'AgentCard', schema, resolver
    )
