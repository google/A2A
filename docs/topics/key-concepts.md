...
<img src="../assets/a2a-actors.png" width="70%" alt="A2A Actors showing a User, A2A Client (Client Agent), and A2A Server (Remote Agent)" style="margin:20px auto;display:block;">
