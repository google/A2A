...
class FingerprintGenerator:
    ...
    def __init__(self, private_key: Optional[str] = None, ethereum_url: Optional[str] = None):
        """
    ...
    def generate_fingerprint(
        ...
        signed_message = self.w3.eth.account.sign_message(message, private_key=self.account.key)
    ...
    def _register_on_blockchain(self, hash_hex: str, signature: str) -> str:
        ...
        return f"0x{hashlib.sha256((hash_hex + signature).encode()).hexdigest()}"
