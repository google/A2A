...
class ExecutorInput(BaseModel):
    """Input schema for the Executor Agent."""

    tasks: List[Task] = Field(
        description='The list of tasks received from the Planner.'
    )
...
class ExecutorOutput(BaseModel):
    """Output schema for the Executor Agent."""

    final_result: str = Field(
        description='The final answer or summary of the execution.'
    )
    execution_log: List[str] = Field(
        description='A log of actions taken for each task.'
    )
