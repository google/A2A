...
To interact with the servers, use an A2AClient in a host app (such as the CLI). See [Host Apps](/samples/python/src/google_a2a/hosts/README.md) for details.

* [**Google ADK**](/samples/python/src/google_a2a/agents/google_adk/README.md)
